                                    ...
                                    <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"" height=""50%"" style=""max-width: 500px;max-height: 500px; "" align=""center"">
                                        <tr>
                                            <td bgcolor=""aliceblue"" style=""padding: 25px; text-align: center;border-radius: 10px;"">
                                                ...
                                                <p style=""font-size: 16px;color: black;"">We're happy you signed up for G5Shop. To start exploring the Phone Shop Website, please confirm your email address.</p>
                                                ...
                                                <p style=""font-size: 18px;color: black;"">Welcome to G5Shop!</p>
                                            </td>
                                        </tr>
                                    </table>
                                </body>
