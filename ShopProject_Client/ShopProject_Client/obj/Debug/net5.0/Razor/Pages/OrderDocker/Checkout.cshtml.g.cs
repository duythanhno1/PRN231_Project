#pragma checksum "D:\Ky 8\PRN231\project\PRN231_Project-main\ShopProject_Client\ShopProject_Client\Pages\OrderDocker\Checkout.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "dfb56a519eba9ac3b72e50ab3cc9d1e50cb6a814e8099e55cc16e363814a211b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"dfb56a519eba9ac3b72e50ab3cc9d1e50cb6a814e8099e55cc16e363814a211b", @"/Pages/OrderDocker/Checkout.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "D:\Ky 8\PRN231\project\PRN231_Project-main\ShopProject_Client\ShopProject_Client\Pages\OrderDocker\Checkout.cshtml"
...
<script>
    $(document).ready(function () {
        ...
        if (accessToken != null) {
            const decodedPayload = decodeToken(accessToken);
            var tokendecode = decode");
            WriteLiteral(@"dPayload;
        }
        else {
            tokendecode = null;
        }
...
<script>
    $(document).ready(function () {
        ...
        // Lấy dữ liệu từ biểu mẫu
        var accessToken = sessionStorage.getItem(""a");
            WriteLiteral(@"uToken"");
        if (accessToken != null) {
            const decodedPayload = decodeToken(accessToken);
            var tokendecode = decodedPayload;
